...
\\[1cm]
Aihe 129: aurinkokuntasimulaattori }
\end{center}
...
Ohjelma jakautuu pääasiassa kolmeen osaan: raaka simulaatio, konfigurointikäyttöliittymä ja renderöinti. Simulaation ja asetustiedoston hallinnan voi testata varsin tarkasti ja automaattisesti, mutta käyttöliittymän testailuun on hiiren klikkailua vaikeaa simuloida, joten sitä testaillaan käyttämällä ohjelmaa.
...
\begin{itemize}
	...
	\item Simulaation kaavojen toimivuus: Lagrangen pisteessä oleva kappale pysyy paikallaan,  maa kiertää auringon siinä ajassa kun oikeastikin, maan ja auringon välinen etäisyys ei muutu eri kiertojen aikana.
	...
	\item Renderöinnin oikeellisuus planeettojen sijaintien, suuntavektorien, ratojen ym. osalta: kappaleiden sijainnit vastaavat sitä, mitä ne ovat konfiguraationäkymässä paikan seurannassa ja lokitiedostossa kuhunkin aikaan.
	...
	\item Origon määritys: muu maailma käyttäytyy siten, että seurattu kappale olisi origo.
